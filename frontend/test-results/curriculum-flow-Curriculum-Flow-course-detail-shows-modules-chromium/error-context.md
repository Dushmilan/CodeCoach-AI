...
- Name: curriculum-flow.spec.ts >> Curriculum Flow >> course detail shows modules
- Location: e2e\curriculum-flow.spec.ts:23:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/learn/python-fundamentals
Call log:
  - navigating to "http://localhost:3000/learn/python-fundamentals", waiting until "load"
