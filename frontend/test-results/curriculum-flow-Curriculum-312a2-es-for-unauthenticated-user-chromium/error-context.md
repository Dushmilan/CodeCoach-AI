...
- Name: curriculum-flow.spec.ts >> Curriculum Flow >> learn page shows courses for unauthenticated user
- Location: e2e\curriculum-flow.spec.ts:15:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/learn
Call log:
  - navigating to "http://localhost:3000/learn", waiting until "load"
