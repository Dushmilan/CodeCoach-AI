...
- Name: curriculum-flow.spec.ts >> Curriculum Flow >> exercise lesson shows editor
- Location: e2e\curriculum-flow.spec.ts:35:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/learn/lesson/py-io
Call log:
  - navigating to "http://localhost:3000/learn/lesson/py-io", waiting until "load"
