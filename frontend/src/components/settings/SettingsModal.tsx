...
export function SettingsModal({ open, onClose, isAuthenticated = false, onLogout, plan = 'free', }: SettingsModalProps) {
  ...
  const tabRefs = useRef<Record<Section, HTMLButtonElement | null>>({ general: null, plan: null, account: null });
