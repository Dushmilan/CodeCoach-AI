...
vi.mock("./QuestionList", () => ({
  QuestionList: vi.fn(
    ({
      ...
      onSelectQuestion: (q: QuestionSummary, i: number) => void;
    }) => (
...
vi.mock("./QuestionDescriptionPanel", () => ({
  QuestionDescriptionPanel: vi.fn(
    ({
      selectedQuestion,
      onToggleView,
    }: {
      selectedQuestion: QuestionSummary;
      onToggleView: () => void;
    }) => (
...
describe("Sidebar", () => {
  ...
  it("switches to description mode when view mode toggle is clicked", async () => {
    ...
    expect(
      await screen.findByTestId("mock-question-description"),
    ).toBeInTheDocument();
  ...
  it("switches back to list mode when Back to list is clicked in description mode", async () => {
    ...
    expect(await screen.findByTestId("mock-question-list")).toBeInTheDocument();
    expect(
      screen.queryByTestId("mock-question-description"),
