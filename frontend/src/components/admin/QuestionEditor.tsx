...
export default function QuestionEditor({
  ...
  const removeExample = (idx: number) => {
    ...
    setExamples(
      next.length ? next : [{ input: "", output: "", explanation: "" }],
    );
    emit({
      examples: next.length
        ? next
        : [{ input: "", output: "", explanation: "" }],
    });
  };
          ...
          {examples.map((ex, idx) => (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  updateExample(idx, "explanation", e.target.value)
                }
              />
            </div>
          ))}
          ...
          {testCases.map((tc, idx) => (
            ...
            >
              ...
              <input
                ...
                onChange={(e) =>
                  updateTestCase(idx, "description", e.target.value)
                }
              />
            </div>
          ))}
