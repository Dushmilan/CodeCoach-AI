...
describe('AIChatPanel', () => {
  ...
  it('renders MessageList with messages', () => {
    const messages = [{ id: '1', role: 'user' as const, content: 'help me', timestamp: new Date() }];
  ...
  it('renders QuickActions and ChatInput', () => {
    ...
    expect(screen.getByPlaceholderText('Ask a question or describe your approach...')).toBeInTheDocument();
  });
  ...
  it('calls onSendMessage with input value and clears after send', async () => {
    ...
    const textarea = screen.getByPlaceholderText('Ask a question or describe your approach...');
    ...
    expect(onSendMessage).toHaveBeenCalledWith('how does recursion work', 'freeform');
