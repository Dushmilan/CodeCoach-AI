#!/usr/bin/env python3
"""Seed curriculum (courses/modules/lessons) from JSON files into MySQL.
...
Usage:
    python scripts/seed_curriculum.py [--force] [--url DATABASE_URL]
"""
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Seed curriculum JSON into MySQL")
    parser.add_argument(
        "--force",
        action="store_true",
