...
def upgrade() -> None:
    ...
    sa.Column('company_tags', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('description', sa.Text(), nullable=False),
    sa.Column('starter_code', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('examples', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('test_cases', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    sa.Column('hints', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    ...
    sa.Column('constraints', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    ...
    op.create_index('ix_questions_company_tags', 'questions', ['company_tags'], unique=False, postgresql_using='gin')
    ...
    sa.Column('completed_lessons', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=False),
    ...
    op.create_index('ix_progress_user_course', 'course_progress', ['user_id', 'course_id'], unique=True)
    ...
    sa.Column('test_cases', postgresql.JSONB(astext_type=Text()).with_variant(sa.JSON(), 'sqlite'), nullable=True),
    ...
    op.create_index(op.f('ix_lessons_question_id'), 'lessons', ['question_id'], unique=False)
...
def downgrade() -> None:
    ...
    op.drop_table('users')
    op.drop_index('ix_questions_company_tags', table_name='questions', postgresql_using='gin')
